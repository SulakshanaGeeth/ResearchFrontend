...
class MyTemplate extends StatefulWidget {
  const MyTemplate({super.key, required this.title,required this.child,this.appbar=false,required this.bg});
    final String title;
    final Widget child;
    final bool appbar;
    final Color bg;
    ...
    return Scaffold(
      ...
      appBar:
            widget.appbar ? AppBar(
              ...
              title: Text(widget.title,style: TextStyle(color: MyStyles.cWhite),),
              leading: GestureDetector(
                  onTap: () { nextPage('/home');},
                  child: Icon(Icons.home, color: MyStyles.cWhite,),
              ),
